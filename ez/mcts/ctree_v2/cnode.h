...
namespace tree {
    ...
    class CNode {
        public:
            ...
            float reward_sum, prior, value_sum, similarity;
            ...
            void expand(int to_play, int hidden_state_index_x, int hidden_state_index_y, float reward_sum, const std::vector<float> &policy_logits);
    ...
    class CRoots{
        public:
            ...
            void prepare(float root_exploration_fraction, const std::vector<std::vector<float>> &noises, const std::vector<float> &reward_sums, const std::vector<std::vector<float>> &policies);
            void prepare_no_noise(const std::vector<float> &reward_sums, const std::vector<std::vector<float>> &policies);
            void clear();
